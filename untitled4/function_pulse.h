#ifndef FUNCTION_PULSE_H
#define FUNCTION_PULSE_H

typedef void (*Updata_function)(void);

typedef struct Pulse_Mode_Typedef
{
...
extern Pulse_Mode_Typedef pulse_mode[6];

void pulse_set_send_data(Pulse_Mode_Typedef *dc_mdoe);


#endif // FUNCTION_PULSE_H
